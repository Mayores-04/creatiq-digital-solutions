export function AboutSection() {
  return (
    <section id="about" className="relative py-20 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-10 xl:px-16">
      ...
      <div className="mx-auto mt-16 h-px w-full max-w-md bg-gradient-to-r from-transparent via-secondary to-transparent sm:mt-20" />
    </section>
  );
}
