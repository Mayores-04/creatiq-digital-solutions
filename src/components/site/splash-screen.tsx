...
export function SplashScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-1/2 top-[48%] h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-400/12 blur-3xl sm:h-[42rem] sm:w-[42rem]" />

      <div className="pointer-events-none absolute left-1/2 top-[48%] h-[20rem] w-[20rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/14 blur-3xl sm:h-[32rem] sm:w-[32rem]" />

      <div className="pointer-events-none absolute left-1/2 top-[47%] h-[14rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-sky-400/8 blur-2xl sm:h-[22rem] sm:w-[48rem]" />

      <div className="pointer-events-none absolute inset-0 tech-grid opacity-15 sm:opacity-20" />
