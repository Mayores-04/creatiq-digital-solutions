    ...
    <main className="min-h-screen bg-background">
      <header className="border-b border-cyan-300/15 bg-surface/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:h-20 lg:px-10">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-bold uppercase tracking-widest text-secondary transition hover:bg-cyan-300/10"
          >
            <ArrowLeft size={16} />
            Back to home
          </Link>
      ...
      <section className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-28">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <h1 className="mt-4 text-4xl font-black tracking-[-0.05em] text-primary sm:text-5xl">
            {title}
          </h1>
